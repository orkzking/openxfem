...
//! ^ noded isoparametric triangle elements for plane elasticity
/*!
...
The connectivity of element : [cornerNode_1 cornerNode_2 cornerNode_3 midNode_1 midNode_2 midNode_3]
...
class Tri6_U : public PlaneProblem
{
public :

  Tri6_U (int,Domain*) ;    //!< constructor
  ~Tri6_U ()  {}            //!< destructor
   ...
   */
  FEI2dTriQuad*      giveFEInterpolation();
  /**
  ...
  double   area();
  /*!
   Make a triangle from three corner nodes of the receiver so that can use Cyrille's facilities.
   */
